...
```bash
git remote add origin git@github.com:zeloscloud/zelos-extension-ocpp.git
...
├── zelos_extension_ocpp/  # Your extension package
│   ├── __init__.py
...
from zelos_extension_ocpp.extension import MyExtension
